...
igc-dropdown-item {
  --item-color: var(--ig-surface-500-contrast);
  --hover-item-color: var(--ig-surface-500-contrast);
}
...
igc-slider {
  --inactive-background: hsla(var(--ig-secondary-500), 0.48);
}

igc-list,
igc-list-item {
  --separator-color: hsla(var(--ig-gray-100), var(--ig-gray-a));
}

igc-tab {
  --hover-color: hsla(var(--ig-primary-400), var(--ig-primary-a));
}

igc-tree-item {
  --hover-color: hsla(var(--ig-gray-500), 0.3);
}

igc-nav-drawer-item {
  --hover-background: hsla(var(--ig-gray-100), var(--ig-gray-a));
}
