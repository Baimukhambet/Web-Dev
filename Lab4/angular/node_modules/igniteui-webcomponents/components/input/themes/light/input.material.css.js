...
[part=end] > [part=suffix] ::slotted(*), [part=start] > [part=prefix] ::slotted(*) {
  ...
  width: max-content;
  height: 100%;
  padding-inline: max(var(--is-large, 1) * 16px * var(--ig-spacing-inline-large, var(--ig-spacing-inline, --ig-spacing)), var(--is-medium, 1) * 14px * var(--ig-spacing-inline-medium, var(--ig-spacing-inline, --ig-spacing)), var(--is-small, 1) * 12px * var(--ig-spacing-inline-small, var(--ig-spacing-inline, --ig-spacing)));
}
...
[part=end] {
  ...
  display: -ms-flexbox;
  display: flex;
  min-width: max(var(--is-large, 1) * 0.875rem, var(--is-medium, 1) * 0.75rem, var(--is-small, 1) * 0.625rem);
  height: var(--size);
  overflow: hidden;
}
